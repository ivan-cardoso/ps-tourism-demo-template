          ...
          >
            {TESTIMONIALS.items.map((testimonial) => (
              <div key={testimonial.id} className="px-2 md:px-3">
                <article className="bg-background rounded-2xl p-4 md:p-6 lg:p-8 text-center relative min-h-48 flex flex-col justify-between select-none">
                  <div>
                    <Quote
                    ...
                    <blockquote className="text-base md:text-base 2xl:text-lg text-dark leading-relaxed mb-4 md:mb-6 italic line-clamp-4">
                      "{testimonial.comment}"
                    </blockquote>
                  </div>
