      ...
      <SectionWrapper id="gallery">
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <div className=" bg-gradient-to-br from-secondary via-secondary/95 to-secondary rounded-xl border-6  border-background p-8 flex flex-col justify-center h-full  text-white shadow-xl">
            ...
            {GALLERY.images.map((image, index) => (
              ...
              >
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-primary/0 group-hover:bg-secondary/35 transition-colors duration-300 flex items-center justify-center">
