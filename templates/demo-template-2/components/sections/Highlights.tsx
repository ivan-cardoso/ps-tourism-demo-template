          ...
          <div className="flex">
            {highlights.map((item, i) => {
              ...
              return (
                ...
                >
                  <div className="flex flex-col bg-primary/10 items-center w-full h-full p-3 rounded-md shadow-sm overflow-hidden">
                    <Icon className="w-8 h-8 md:w-10 md:h-10 stroke-[1.5px] text-primary mb-3" />
