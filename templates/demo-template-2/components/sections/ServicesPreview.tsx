            ...
            >
              <Card hover className="h-full bg-background">
                ...
                <div className="p-6 space-y-2.5">
                  <h3 className="text-2xl xl:text-3xl font-heading font-semibold text-primary/95 mb-2">
                    {item.name}
                  </h3>

                  <p className=" text-background w-fit capitalize bg-primary/80 px-3 py-1 rounded-md">
                    {item.feature}
                  </p>
