...
interface NavbarProps {
  variant?: "default" | "solid" | "accent" | "white";
}
...
export default function Navbar({ variant = "default" }: NavbarProps) {
  ...
  const backgroundClasses = {
    default: isScrolled
      ...
      : "bg-transparent",
    solid: "bg-primary/90 backdrop-blur-sm shadow-lg",
      ...
      <nav className={cn("container mx-auto ")}>
        <div
          className={cn(
            ...
            isOpen ? "bg-primary/90" : "bg-transparent",
        ...
        >
          ...
          >
            {/* <Image
              src="https://kitpro.site/nacotta/wp-content/uploads/sites/190/2023/09/Logo-1.png"
            ...
            <span
              className={cn(
                "text-xl lg:text-2xl font-heading font-bold  transition-colors",
                textClasses[variant]
              )}
            >
