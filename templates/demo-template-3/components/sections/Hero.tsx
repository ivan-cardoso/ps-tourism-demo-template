  ...
  return (
    ...
    >
      ...
      <div className=" container mx-auto px-4 sm:px-6 lg:px-8 xl:px-20 relative z-20">
        <div className="flex flex-col gap-8 lg:gap-16 justify-end min-h-screen py-16 lg:py-20">
          <div className="text-center">
            ...
            <AnimatedElement animation="fade-up" delay={400}>
              <h1
                className="
                font-heading text-3xl md:text-4xl lg:text-5xl xl:text-6xl 
                font-bold leading-tight mb-6 mt-16 lg:mt-20  text-white"
              >
                {HERO.title}
              </h1>
            </AnimatedElement>
            ...
            <AnimatedElement animation="fade-up" delay={600}>
              <p className="text-base md:text-lg font-semibold text-white/90 max-w-2xl mx-auto leading-relaxed mb-8">
                {HERO.subtitle}
              </p>
            </AnimatedElement>
