            ...
            >
              {settings.navigation.map((item) => (
                <Link
                  ...
                  className="block px-3 py-2 text-primary hover:text-accent hover:bg-[#F8F4ED] rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2"
                >
                  {item.label}
                </Link>
              ))}
